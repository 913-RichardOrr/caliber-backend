 ...
 */
function getWeeksByBatchId(batchId) {
    return __awaiter(this, void 0, void 0, function () {
        var client, query, result, headers, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    query = 'select qcWeekId, weekNumber, note, overallStatus, batchId from qcWeeks where batchId = $1::text';
                    return [4 /*yield*/, client.query(query, [batchId])];
                case 3:
                    result = _a.sent();
                    headers = {
...
exports.default = getWeeksByBatchId;
